...
export default function MedicineSection() {
  ...
  const pharmacyPhone = "1234567890"; 
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 reveal">
          <div className="space-y-4">
            <div className="bg-blue-50 text-blue-600 px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest w-fit">
              Direct Dispensing
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter">
              Quick <span className="text-blue-600 font-outline-2">Catalog</span>
            </h2>
          ...
          <div className="relative w-full md:w-96 group">
            ...
            <input 
              ...
              className="w-full pl-14 pr-6 py-4 bg-slate-50 border border-slate-200 rounded-[2rem] focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredMeds.map((med) => (
            <div key={med.id} className="group p-8 bg-slate-50 rounded-[2.5rem] border border-transparent hover:border-blue-100 hover:bg-white hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-500 reveal">
              <div className="flex justify-between items-start mb-6">
                <div className="bg-white p-4 rounded-2xl shadow-sm text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                  <Pill size={28} />
                </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                <div className="flex flex-col">
                  ...
                  <span className="text-2xl font-black text-blue-900">${med.price.toFixed(2)}</span>
                </div>
                <button 
        ...
        {filteredMeds.length === 0 && (
          <div className="text-center py-24 bg-slate-50 rounded-[3.5rem] border-2 border-dashed border-slate-200 reveal">
            ...
            <button 
              onClick={() => window.open(`https://wa.me/${pharmacyPhone}?text=Hi Liza, I am looking for a medicine not in your online list...`, '_blank')}
              className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-black hover:bg-blue-700 transition-all shadow-lg shadow-blue-200"
            >
