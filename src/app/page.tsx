...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      {/* 1. Hero Section */}
      <section className="relative bg-blue-900 text-white pt-24 pb-40 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center reveal">
          <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold mb-8 border transition-colors ${
            isOpen ? 'bg-emerald-500/10 text-emerald-300 border-emerald-500/30' : 'bg-amber-500/10 text-amber-300 border-amber-500/30'
          }`}>
          ...
          <h1 className="text-5xl md:text-8xl font-black mb-8 tracking-tighter leading-[1.1]">
            Modern Care, <br />
            <span className="text-blue-400">Local Heart.</span>
          </h1>
          
          <p className="text-xl mb-12 text-blue-100 max-w-2xl mx-auto font-medium leading-relaxed opacity-90">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-5">
            <Link 
              href="/upload" 
              className="bg-white text-blue-900 px-10 py-5 rounded-2xl font-black shadow-2xl hover:scale-105 transition-all text-lg flex items-center justify-center gap-2 group"
            >
              Upload Prescription
            ...
            <Link 
              href="/services" 
              className="bg-blue-800/40 backdrop-blur-md border-2 border-white/20 px-10 py-5 rounded-2xl font-bold hover:bg-white/10 transition-all text-lg text-center"
            >
              View Services
            </Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto -mt-20 px-6 relative z-20">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={i} 
              className="bg-white p-8 rounded-[2.5rem] shadow-xl shadow-blue-900/5 border border-slate-100 flex flex-col items-start group hover:-translate-y-2 transition-all duration-300"
            >
      ...
      <div className="mt-24 py-12 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 mb-12 flex justify-between items-end">
          ...
          <Link href="/shop" className="text-blue-600 font-bold flex items-center gap-2 hover:underline">
      ...
      <section className="py-32 px-6 bg-white border-y border-slate-100 relative overflow-hidden">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal">
            <div className="flex items-center gap-2 text-blue-600 font-bold mb-4 uppercase tracking-widest text-sm">
              <Activity size={18} />
              <span>Why Liza's Pharmacy</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 mb-8 leading-tight tracking-tighter">
              Your Health <br />
              <span className="text-blue-600">Is Personal.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                { icon: <Clock className="text-blue-500" />, text: "Automated Reminders" },
                { icon: <CheckCircle className="text-emerald-500" />, text: "Insurance Direct-Billing" },
                { icon: <Stethoscope className="text-blue-500" />, text: "Private Consult Room" },
              ].map((feature, i) => (
          ...
          <div className="relative group">
            <div className="absolute -inset-4 bg-blue-100 rounded-[4rem] rotate-2 transition-transform group-hover:rotate-0"></div>
            <div className="relative bg-blue-600 rounded-[3.5rem] aspect-square overflow-hidden flex flex-col items-center justify-center text-white p-12 shadow-2xl">
               <Stethoscope size={140} className="text-blue-300 opacity-50 mb-6" strokeWidth={1} />
               <div className="text-center">
                 <p className="text-4xl font-black mb-2">Since 2024</p>
                 <p className="text-blue-200 font-medium italic">Dedicated Downtown Healthcare</p>
               </div>
            </div>
          </div>
        </div>
